  ...
  if (!img) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Resim Düzenleme</h1>
          <p className="mt-1 text-sm text-slate-500">
            Rapor fotoğraflarını kırpın, döndürün, iyileştirin ve küçültün. İşlem tarayıcınızda yapılır, görsel hiçbir yere yüklenmez.
          </p>
        </div>
        <div
          onDragOver={(e) => {
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-sm text-slate-500">
            {dosyaAdi} · {img.naturalWidth}×{img.naturalHeight} · {boyutYaz(asilBoyut)}
          </p>
        </div>
